...
public class FenceServiceProxy extends AbstractFenceService implements Proxy {
	
  private String host;
  private int port;

  public FenceServiceProxy(String host, int port) {
    this.host = host;
    this.port = port;
  }
  public long enqueue(Message message) { 
    ...
    request.setServiceId(3025599164L);
    request.setMethodId(2793935161L);
  ...
  public short getStatus(long id) { 
    ...
    Request request = new Request();
    request.setServiceId(3025599164L);
    request.setMethodId(2122157182L);
    request.setArgumentCount((byte) 1);
    request.setType(Request.RequestType.InvokeStateless);
    Argument arg0 = new Argument();
  ...
  public void discard(long id) { 
    ...
    Request request = new Request();
    request.setServiceId(3025599164L);
    request.setMethodId(2455713280L);
    request.setArgumentCount((byte) 1);
    request.setType(Request.RequestType.InvokeStateless);
    Argument arg0 = new Argument();
    arg0.setDataLength(serializedId.length);
  ...
  public boolean hasMore(String label) { 
    ...
    Request request = new Request();
    request.setServiceId(3025599164L);
    request.setMethodId(349651851L);
    request.setArgumentCount((byte) 1);
    request.setType(Request.RequestType.InvokeStateless);
    Argument arg0 = new Argument();
  ...
  public Message popNext(String label) { 
    ...
    Request request = new Request();
    request.setServiceId(3025599164L);
    request.setMethodId(3680821099L);
    request.setArgumentCount((byte) 1);
    request.setType(Request.RequestType.InvokeStateless);
    Argument arg0 = new Argument();
    arg0.setDataLength(serializedLabel.length);
  ...
  public void ack(long id) { 
    ...
    Request request = new Request();
    request.setServiceId(3025599164L);
    request.setMethodId(529598591L);
    request.setArgumentCount((byte) 1);
    request.setType(Request.RequestType.InvokeStateless);
    Argument arg0 = new Argument();
    arg0.setDataLength(serializedId.length);
