...
public class FenceTestServiceProxy extends AbstractFenceTestService implements Proxy {
	
  private String host;
  private int port;

  public FenceTestServiceProxy(String host, int port) {
    this.host = host;
    this.port = port;
  }
  public long enqueueAsIncomingMessage(Message message) { 
    ...
    request.setServiceId(908149993L);
    request.setMethodId(1407035185L);
