...
namespace transport {
  ...
  TransportMessage::Serialize(uint32_t *length_ptr) {
    ...
    totalLength += length3;
    uint32_t length4 = 0;
    ::org::labcrypto::hottentot::runtime::HotPtr<unsigned char, true> ptr4;
    ptr4 = label_.Serialize(&length4);
    if (length4 < 128) {
    ...
    uint32_t length5 = 0;
    ::org::labcrypto::hottentot::runtime::HotPtr<unsigned char, true> ptr5;
    ptr5 = content_.Serialize(&length5);
    if (length5 < 128) {
