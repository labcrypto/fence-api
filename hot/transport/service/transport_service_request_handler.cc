...
namespace service {
  ...
  TransportServiceRequestHandler::HandleRequest(::naeem::hottentot::runtime::Request &request, ::naeem::hottentot::runtime::Response &response) {
    if (request.GetMethodId() == 2333304302) {
      ...
      try {
        serviceObject->Enqueue(messages, result, hotContext);      messages.Purge();
    ...
    if (request.GetMethodId() == 3403040507) {
      ...
      ::naeem::hottentot::runtime::types::Enum< ::ir::ntnaeem::gate::transport::TransportMessageStatus> result;
      try {
