...
#ifndef _ORG_LABCRYPTO_FENCE_TRANSPORT__SERVICE__TRANSPORT_MONITOR_SERVICE_REQUEST_HANDLER_H_
#define _ORG_LABCRYPTO_FENCE_TRANSPORT__SERVICE__TRANSPORT_MONITOR_SERVICE_REQUEST_HANDLER_H_
...
namespace transport {
namespace service {
  class TransportMonitorServiceRequestHandler : public ::org::labcrypto::hottentot::runtime::service::RequestHandler {
  public:
    TransportMonitorServiceRequestHandler(::org::labcrypto::hottentot::runtime::service::Service *service)
