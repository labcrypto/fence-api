 ...
 * Name: fence_monitor_service_request_handler.cc
 * Description:
...
#include "abstract_fence_monitor_service.h"
...
namespace service {
  void 
  FenceMonitorServiceRequestHandler::HandleRequest(::org::labcrypto::hottentot::runtime::Request &request, ::org::labcrypto::hottentot::runtime::Response &response) {
    if (request.GetMethodId() == 3234349133) {
      ::org::labcrypto::fence::service::AbstractFenceMonitorService *serviceObject = 
        dynamic_cast< ::org::labcrypto::fence::service::AbstractFenceMonitorService*>(service_);
      /*
