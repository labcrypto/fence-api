...
#ifndef _ORG_LABCRYPTO_FENCE__SERVICE__ABSTRACT_GATE_SERVICE_H_
#define _ORG_LABCRYPTO_FENCE__SERVICE__ABSTRACT_GATE_SERVICE_H_
...
namespace fence {
namespace service {
  class AbstractGateService : public GateService, public ::org::labcrypto::hottentot::runtime::service::Service {
  public:
    AbstractGateService() {}
