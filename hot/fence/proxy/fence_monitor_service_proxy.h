 ...
 * Name: fence_monitor_service_proxy.h
 * Description:
 *   This file contains definition of the proxy class.
 ***************************************************************/

#ifndef _ORG_LABCRYPTO_FENCE__PROXY__FENCE_MONITOR_SERVICE_PROXY_H_
#define _ORG_LABCRYPTO_FENCE__PROXY__FENCE_MONITOR_SERVICE_PROXY_H_
...
class Message;
namespace proxy {
  class FenceMonitorServiceProxy : public FenceMonitorService, 
    public ::org::labcrypto::hottentot::runtime::proxy::Proxy {
  public:
    FenceMonitorServiceProxy(std::string host, uint32_t port) 
      : ::org::labcrypto::hottentot::runtime::proxy::Proxy(host, port) {}
    virtual ~FenceMonitorServiceProxy() {}
  public:
