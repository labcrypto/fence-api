 ...
 * Name: fence_monitor_service_client.h
 * Description:
...
#include "../message.h"
#include "../proxy/fence_monitor_service.h"
#include "../proxy/fence_monitor_service_proxy_builder.h"
...
main(int argc, char **argv) {
  try {
    ...
    ::org::labcrypto::fence::proxy::FenceMonitorService *proxy = 
      ::org::labcrypto::fence::proxy::FenceMonitorServiceProxyBuilder::Create("127.0.0.1", 2000);
    if (::org::labcrypto::hottentot::runtime::Configuration::Verbose()) {
      ::org::labcrypto::hottentot::runtime::Logger::GetOut() << 
        "[" << ::org::labcrypto::hottentot::runtime::Utils::GetCurrentUTCTimeString() << "]: " << 
