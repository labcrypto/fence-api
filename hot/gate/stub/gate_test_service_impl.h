...
#ifndef _ORG_LABCRYPTO_FENCE__GATE_TEST_SERVICE_IMPL_H_
#define _ORG_LABCRYPTO_FENCE__GATE_TEST_SERVICE_IMPL_H_
...
namespace labcrypto {
namespace fence {
  class GateTestServiceImpl : public ::org::labcrypto::fence::service::AbstractGateTestService {
  public:
    GateTestServiceImpl() {}
