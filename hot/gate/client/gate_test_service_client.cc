 ...
 * Name: gate_test_service_client.h
 * Description:
...
#include "../message.h"
#include "../proxy/gate_test_service.h"
#include "../proxy/gate_test_service_proxy_builder.h"
...
main(int argc, char **argv) {
  try {
    ...
    ::org::labcrypto::fence::proxy::GateTestService *proxy = 
      ::org::labcrypto::fence::proxy::GateTestServiceProxyBuilder::Create("127.0.0.1", 2000);
    if (::org::labcrypto::hottentot::runtime::Configuration::Verbose()) {
      ::org::labcrypto::hottentot::runtime::Logger::GetOut() << 
        "[" << ::org::labcrypto::hottentot::runtime::Utils::GetCurrentUTCTimeString() << "]: " << 
    ...
    ::org::labcrypto::fence::proxy::GateTestServiceProxyBuilder::Destroy(proxy);
    if (::org::labcrypto::hottentot::runtime::Configuration::Verbose()) {
      ::org::labcrypto::hottentot::runtime::Logger::GetOut() << 
        "[" << ::org::labcrypto::hottentot::runtime::Utils::GetCurrentUTCTimeString() << "]: " <<
