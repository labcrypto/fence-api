...
main(int argc, char **argv) {
  try {
    ...
    ::ir::ntnaeem::gate::proxy::GateTestService *proxy = 
      ::ir::ntnaeem::gate::proxy::GateTestServiceProxyBuilder::Create("127.0.0.1", 2000);
    if (::naeem::hottentot::runtime::Configuration::Verbose()) {
    ...
    ::ir::ntnaeem::gate::proxy::GateTestServiceProxyBuilder::Destroy(proxy);
    if (::naeem::hottentot::runtime::Configuration::Verbose()) {
