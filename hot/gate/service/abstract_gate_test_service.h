...
#ifndef _ORG_LABCRYPTO_FENCE__SERVICE__ABSTRACT_GATE_TEST_SERVICE_H_
#define _ORG_LABCRYPTO_FENCE__SERVICE__ABSTRACT_GATE_TEST_SERVICE_H_
...
namespace fence {
namespace service {
  class AbstractGateTestService : public GateTestService, public ::org::labcrypto::hottentot::runtime::service::Service {
  public:
