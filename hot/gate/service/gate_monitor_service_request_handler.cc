...
namespace service {
  void 
  GateMonitorServiceRequestHandler::HandleRequest(::org::labcrypto::hottentot::runtime::Request &request, ::org::labcrypto::hottentot::runtime::Response &response) {
    if (request.GetMethodId() == 3427061902) {
      ::org::labcrypto::fence::service::AbstractGateMonitorService *serviceObject = 
        dynamic_cast< ::org::labcrypto::fence::service::AbstractGateMonitorService*>(service_);
      /*
