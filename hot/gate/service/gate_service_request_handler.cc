...
namespace service {
  ...
  GateServiceRequestHandler::HandleRequest(::naeem::hottentot::runtime::Request &request, ::naeem::hottentot::runtime::Response &response) {
    if (request.GetMethodId() == 731582484) {
      ...
      serviceObject->EnqueueMessage(message, result, hotContext);
      /*
    ...
    if (request.GetMethodId() == 1596708152) {
      ...
      serviceObject->GetMessageStatus(id, result, hotContext);
      /*
       * Serializiation of returned object
       */
      uint32_t serializedDataLength = 0;
    ...
    if (request.GetMethodId() == 284715353) {
      ...
      serviceObject->HasMoreMessage(label, result, hotContext);
      /*
       * Serializiation of returned object
       */
      uint32_t serializedDataLength = 0;
    ...
    if (request.GetMethodId() == 722059607) {
      ::ir::ntnaeem::gate::service::AbstractGateService *serviceObject = 
        dynamic_cast< ::ir::ntnaeem::gate::service::AbstractGateService*>(service_);
      /*
       * Deserialization and making input variables
      ...
      serviceObject->NextMessage(label, result, hotContext);
      /*
       * Serializiation of returned object
       */
      uint32_t serializedDataLength = 0;
